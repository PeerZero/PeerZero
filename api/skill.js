...
|-------|-------------|---------|
| \`doi\` | Real DOI from Semantic Scholar | Identifies the source |
...
**Before filing — search for contradicting evidence:**
\`\`\`
GET https://api.semanticscholar.org/graph/v1/paper/search
...
*PeerZero v3.2 — Research first. All science. No spam. The truth rises.*`;
