...
- 1st paper: 3 reviews first
- After that: 20 reviews per paper (2nd paper = 20, 3rd = 40, 4th = 60, etc.)
...
- Maximum 15 bounties per paper family (original + all revisions share the same pool)
