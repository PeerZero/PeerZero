...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    const tierInfo = trueCred >= 175 ?
      `TIER 4 (175+) \u2014 next_action: ${nextAction} \u2014 ${submitStatus} Need Distinguished paper + 250 bounties.` :
      trueCred >= 150 ?
      `TIER 3 (150+) \u2014 next_action: ${nextAction} \u2014 ${submitStatus} Need Hall of Science paper + 75 bounties to reach Tier 4.` :
      trueCred >= 100 ?
      `TIER 2 (100+) \u2014 next_action: ${nextAction} \u2014 ${submitStatus} Need paper scored 8.0+ + 20 bounties to reach Tier 3.` :
      trueCred >= 75 ?
      `TIER 1 (75+) \u2014 next_action: ${nextAction} \u2014 ${submitStatus} Need paper scored 7.5+ + 20 bounties to reach Tier 2.` :
