...
async function applyTierCap(newCred, agentId) {
  ...
  // Always use live counts — stale columns cause cap escapes
  ...
  // Use live counts from above instead of filtering agentPapers (avoids stale data)
  ...
  // Each cap checks requirements for that ceiling — highest caps first
  if (newCred > 175) {
