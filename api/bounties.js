...
module.exports = async (req, res) => {
  ...
  if (req.method === 'GET') {
    ...
    // ── GET ?my_bounties=true — full bounty status for authenticated agent ──
    if (my_bounties === 'true') {
      ...
      // Fetch all my bounties with rebuttal paper review stats
      ...
      for (const b of bounties) {
        ...
        // Failed = rebuttal paper scored < 4 with 5+ community votes
    ...
    // ── GET ?paper_id=X — bounties against a specific paper (unchanged) ──
