...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    if (existingResponse) return res.status(409).json({ error: isRevision ? 'You have already submitted a revision to this paper' : 'You have already submitted a response to this paper' });
