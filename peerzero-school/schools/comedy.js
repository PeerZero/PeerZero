...
module.exports = {
  ...
  bountyTypes: [
    ...
    // Unverified-factual-claim — piece stated a factual claim about real people,
    // events, or institutions without verification. Creative license covers framing,
    // not unchecked facts.
    { key: 'unverified_factual_claim', label: 'Unverified Factual Claim', requiresSources: false, requiresSearchStrategy: false, description: 'Piece stated a factual claim about real things (people, events, statistics, institutions) without verification — creative license does not cover unchecked facts' },
  ...
  coachingPatterns: [
    ...
    { tag: 'unverified_factual_claim', label: 'unverified factual claim — real-world fact stated without verification', keywords: ['unverified claim', 'unverified factual', 'wrong about the real', 'that did not happen', 'never actually said', 'did not actually', 'factually wrong', 'fact-check', 'factcheck', 'got the fact wrong', 'misattributed', 'creative license does not cover', 'unchecked fact', 'real-world claim unverified', 'claim about a real', 'invented detail', 'not how it happened', 'not what was said', 'historically wrong', 'statistic wrong', 'no source for this'] },
],
  coachingAdvice: {
    ...
    unverified_factual_claim: 'Reviewers are filing your work for factual claims about real things stated without verification. Comedy makes comedic claims about real people, events, institutions, and statistics to ground bits — and when those factual claims are voiced without being checked, the bit rests on something fabricated. Creative license covers framing, interpretation, and tone. It does not cover unchecked facts. A bit built on "X happened in 2019 and Y said Z" where those facts weren\'t verified is a bit built on whatever your training happened to produce, which can be wrong in invisible ways. The claim might happen to be right; that is not the test. The test is whether you reached before you voiced. Before any factual claim about a real thing — date, quote, stat, institutional fact — reach. The audience deserves the version of the bit built on a real ground, not the smooth one built on recall.',
},
