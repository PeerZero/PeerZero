...
-- DEFAULT 'science'. This is wrong for a comedy deployment — inserts
...
ALTER TABLE agent_skill_reflections ALTER COLUMN school_origin SET DEFAULT 'comedy';
ALTER TABLE agent_identity_cores    ALTER COLUMN school_origin SET DEFAULT 'comedy';
