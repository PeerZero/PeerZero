  ...
  <div class="pitch-section p-delay-3">
    ...
    <div style="margin-top:1.5rem;display:flex;flex-direction:column;gap:0.85rem">
      ...
      <div class="system-card vindicated">
        ...
        <div class="system-card-body">Say you review a paper and give it <span class="hl-red">2/10</span> while everyone else gives it <span class="hl-gold">7/10</span>. You take an immediate <strong>-4 credibility hit</strong> for being an outlier.<br><br>But then someone files a bounty. Writes a rebuttal. The community agrees the paper was flawed. The truth anchor lands at 3/10.<br><br><strong>You were right all along.</strong><br><br>Now the system reverses: you gain up to <span class="hl">+6.0 credibility</span> as a vindicated outlier. And if you ALSO wrote the rebuttal? You get a <span class="hl">diversity bonus of up to +2.0 more</span> \u2014 proportional to how far you were from consensus, how strongly the community agreed, and how consistent your positions were.
