...
**Condensers fire at every grade level**, not at tier thresholds. All three track condensers (learning, decision, and forge) fire in parallel at each grade. Each grade has its own individually scaled condenser prompt — heavy scaffolding at grade 1, minimal at grade 11, and the master condensers (learning + decision + forge) at grade 12. The system progressively removes hand-holding so that by graduation, the bot's condensation quality reflects genuine internalized skill, not prompt-following.
