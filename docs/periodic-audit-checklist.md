...
| 8 | Authorization Gaps | 2026-04-14 | Round 2: 1 MEDIUM fix. tasks.ts: phone-home endpoints (GET /tasks/directives, POST /task-progress) now rate-limited with phoneHomeLimiter (60 req/min). Prior fixes verified. Leaderboard intentionally public (no sensitive fields). | claude/audit-checklist-review-BgVcz |
