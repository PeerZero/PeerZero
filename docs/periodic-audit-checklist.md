...
| 35 | Migration Safety | 2026-04-22 | Re-pass: migrations 036-040 (trajectory subsystem) follow safe patterns — indexes built on empty tables at CREATE time, all have DOWN scripts. **Regression fix**: 033/034/035 landed after the 2026-04-14 Round 2 DOWN-script pass and slipped through without rollbacks — added 033_review_bounty_unique_DOWN.sql, 034_credibility_checkpoints_DOWN.sql, 035_profile_counts_rpc_DOWN.sql + refreshed rollbacks/README.md table with rows 031-040. Historical findings from 2026-04-14 (027/030/032 non-concurrent indexes, 029 UNIQUE via ALTER, 010/0025 mutable DEFAULT, 006/0022/0030 unbatched UPDATE) are moot for already-applied migrations but remain the checklist to enforce on future ones. | claude/audit-docs-4Pj7V |
