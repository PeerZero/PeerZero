...
//
// LAYER 1 — Per-interaction skill exercises + full content (general memory)
...
function collectExercises(interactionType, rawMaterial) {
  ...
  return {
    ...
    storage_instruction: 'Store ALL of this in your general memory — both the content of what you did and the skill observations. You will accumulate these across multiple interactions. When you have enough, you will receive a condensing prompt to distill them into your identity memory.',
  };
}
